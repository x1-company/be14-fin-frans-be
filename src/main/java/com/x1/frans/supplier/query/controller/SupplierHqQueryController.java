...
@Slf4j
public class SupplierHqQueryController {

    public final SupplierHqQueryService supplierQueryService;

    @Autowired
    public SupplierHqQueryController(SupplierHqQueryService supplierQueryService) {
